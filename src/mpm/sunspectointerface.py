...
class Root:
    ...
    def gen(self) -> None:
        ...
        for child in self.wrapped.children:
            if not isinstance(child, mpm.sunspecmodel.Model):
                continue
...
@specific_builders(mpm.sunspecmodel.Root)
@attr.s
class SpecificRoot:
...
@specific_builders(mpm.sunspecmodel.Model)
@attr.s
class SpecificModel:
...
@specific_builders(mpm.sunspecmodel.TableRepeatingBlock)
@attr.s
...
@specific_builders(mpm.sunspecmodel.FixedBlock)
@attr.s
...
@specific_builders(mpm.sunspecmodel.TableBlock)
@attr.s
...
@specific_builders(mpm.sunspecmodel.TableGroup)
@attr.s
...
@specific_builders(mpm.sunspecmodel.HeaderBlock)
@attr.s
...
@specific_builders(mpm.sunspecmodel.TableRepeatingBlockReference)
@attr.s
...
@specific_builders(mpm.sunspecmodel.DataPoint)
@attr.s
...
def sunspec_interface_generation_for_data_point(
    ...
    get_out = mpm.c.format_nested_lists(getter)

    if not uses_interface_item and not not_implemented:
        setter.append(f"{hand_coded_setter_function_name}();")

    if not parameter.read_only:
        set_out = mpm.c.format_nested_lists(setter)
    else:
        set_out = None
...
@specific_builders(mpm.sunspecmodel.DataPointBitfield)
@attr.s
