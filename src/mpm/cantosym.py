    ...
    def gen(
        ...
        if can_find_parameter:
            ...
            if handle_configuration:
                ...
                imported_variants = mpm.symtoproject.imported_variants
...
class MultiplexedMessage:
    ...
    def gen(self):
        ...
        for child in self.wrapped.children[1:]:
            if isinstance(child, mpm.canmodel.Signal):
                common_signals.append(child)
            elif isinstance(child, mpm.canmodel.CanTable):
                for subchild in child.children:
                    if isinstance(subchild, mpm.canmodel.Multiplexer):
        ...
        for multiplexer in not_signals:
            ...
            if isinstance(multiplexer.tree_parent, mpm.canmodel.CanTable):
