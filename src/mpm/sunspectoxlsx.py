...
@enumeration_builders(mpm.sunspecmodel.DataPoint)
@attr.s
class Enumeration:
    wrapped = attr.ib()
    point = attr.ib()
...
class TableGroup:
    ...
    def gen(self) -> typing.List[typing.List[Fields], int]:
        ...
        for child in points:
            ...
            if isinstance(child, mpm.sunspecmodel.TableGroup):
                rows.extend(built_rows)
            else:
                rows.append(built_rows)
...
class DataPointBitfield:
    ...
    def gen(self):
        ...
        (
            get_out,
            set_out,
        ) = mpm.sunspectointerface.sunspec_interface_generation_for_data_point_bitfield(
...
@enumeration_builders(mpm.sunspecmodel.DataPointBitfield)
@attr.s
class DataPointBitfield:
    wrapped = attr.ib()
    point = attr.ib()
...
@enumerator_builders(mpm.sunspecmodel.DataPointBitfieldMember)
@attr.s
...
@enumeration_builders(mpm.sunspecmodel.HeaderBlock)
@enumeration_builders(mpm.sunspecmodel.FixedBlock)
@enumeration_builders(mpm.sunspecmodel.TableRepeatingBlockReference)
@attr.s
...
@enumeration_builders(mpm.sunspecmodel.TableBlock)
@attr.s
...
@enumeration_builders(mpm.sunspecmodel.TableGroup)
@attr.s
    ...
    def gen(self):
        ...
        if self.wrapped.parameter_uuid is not None:
            ...
            (
                ...
                set_out,
                _,
            ) = mpm.sunspectointerface.sunspec_interface_generation_for_data_point(
                parameter,
                self.sunspec_id,
                self.model_id,
                self.is_table,
