...
class Root:
    ...
    def gen(self) -> None:
        ...
        def sunspec_node_wanted(node: typing.Any) -> bool:
            ...
            wanted_types = (mpm.sunspecmodel.DataPointBitfield,)
        ...
        def staticmodbus_node_wanted(node: typing.Any) -> bool:
            ...
            wanted_types = (mpm.staticmodbusmodel.FunctionDataBitfield,)
            if not isinstance(node, wanted_types):
                return False
        ...
        with self.c_path.open("w", newline="\n") as f:
            f.write(mpm.c.format_nested_lists(c_lines).strip() + "\n")

        with self.h_path.open("w", newline="\n") as f:
            f.write(mpm.c.format_nested_lists(h_lines).strip() + "\n")
...
class DataPointBitfield:
    ...
    def gen(self) -> typing.List:
        ...
        for member in members:
            ...
            variable_type = mpm.parameterstointerface.sunspec_types[
