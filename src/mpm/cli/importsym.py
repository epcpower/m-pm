...
def cli(
    ...
    project_model = mpm.project.Project(
        paths=mpm.project.Models(
    ...
    if add_sunspec_types:
        ...
        enumerations.append_child(
            mpm.sunspecmodel.build_sunspec_types_enumeration(),
        )

    mpm.project._post_load(project_model)
