...
def test_pycparser_exploration_wrapped():
    ...
    top_level.extend(
        mpm.parameterstoc.struct(
            name="StructName",
            member_decls=(
                mpm.parameterstoc.Decl(
                    type=mpm.parameterstoc.Type(
                        name=name,
                        type=type,
                    )
                )
...
def test_single_layer_group_to_c():
    ...
    builder = mpm.parameterstoc.builders.wrap(group)
...
def test_nested_group_to_c():
    ...
    builder = mpm.parameterstoc.builders.wrap(outer_group)
...
def test_datalogger_a():
    ...
    builder = mpm.parameterstoc.builders.wrap(data_logger)
...
def test_basic_parameter_array():
    ...
    builder = mpm.parameterstoc.builders.wrap(array)
...
def test_line_monitor_params():
    ...
    builder = mpm.parameterstoc.builders.wrap(line_monitoring)
...
def test_root():
    ...
    builder = mpm.parameterstoc.builders.wrap(root)
