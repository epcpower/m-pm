...
def test_model_has_header():
    ...
    assert isinstance(header_block, mpm.sunspecmodel.HeaderBlock)
...
def test_table_update_unlinked():
    expected_counts = {
        mpm.sunspecmodel.TableRepeatingBlock: 8,
        mpm.sunspecmodel.DataPoint: 2,
    }
