...
def test_multiplexed():
    ...
    multiplexed_message = mpm.canmodel.MultiplexedMessage(
...
def test_enumerations():
    project = mpm.project.create_blank()
    ...
    message = mpm.canmodel.Message()
    can_root.append_child(message)
    signal = mpm.canmodel.Signal(
...
def test_access_level():
    ...
    access_level_signal = mpm.canmodel.Signal(
        name="AccessSignal",
